  ...
  if (categories.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-zinc-200 px-6 py-16 text-center">
        ...
        <h3 className="text-base font-semibold text-zinc-900">No categories found</h3>
          ...
          <tbody className="divide-y divide-zinc-100 bg-white">
            {categories.map((category, i) => {
              ...
              return (
                ...
                >
                  <td className="px-6 py-4 text-zinc-500">{category.id}</td>

                  <td className="px-6 py-4 font-medium text-zinc-900">{category.name}</td>

                  <td className="max-w-xs truncate px-6 py-4 text-zinc-600">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex justify-end gap-2">
                      <button
                        ...
                        disabled={isDeleting}
                        className="inline-flex h-8 items-center gap-1.5 rounded-lg border border-zinc-300 px-3 text-sm font-medium text-zinc-700 transition-colors duration-150 hover:bg-zinc-50 disabled:cursor-not-allowed disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-900 focus-visible:ring-offset-2"
                      >
                        <PencilIcon />
                        Edit
                      </button>
                      ...
                      <button
                        ...
                        disabled={isDeleting}
                        className="inline-flex h-8 items-center gap-1.5 rounded-lg bg-red-500 px-3 text-sm font-medium text-white transition-colors duration-150 hover:bg-red-600 disabled:cursor-not-allowed disabled:opacity-60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2"
                      >
